...
(that is defined in webcorpus.py).  Note that some of the attribute names
in the WebCorpus class have been renamed with leading underscores, to 
indicate that they should not be used outside of the class implementation.
